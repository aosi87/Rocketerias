 ...
 * funtionality.
 */
public class PDFReaderView extends javax.swing.JFrame
{
    ...
    private void openMenuItemActionPerformed(java.awt.event.ActionEvent evt)
    {
        ...
        int result = chooser.showOpenDialog(PDFReaderView.this);
    ...
    {
        PDFReaderView viewer = new PDFReaderView();
        String password = "";
    ...
    private void showPage(int pageNumber)
    {
        try 
        {
            PageWrapper wrapper = new PageWrapper(new PDFReader());
